   ...
   <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
      ...
      <select name="categoria" id="categoria" class="form-control">
      	...
      	<option value="<?php echo $categoria->id;?>" <?php if($descNoticia->categoria == $categoria->id): echo "selected"; endif;?>><?php echo $categoria->titulo;?></option>
      	<?php endforeach;?>
      </select>
    ...
    <div class="form-group col-md-2">
      ...
      <option value="">SELECIONE</option>
      	<option value="S" <?php if($descNoticia->destaque == 'S'): echo "selected"; endif;?>>Sim</option>
      	<option value="N" <?php if($descNoticia->destaque == 'N'): echo "selected"; endif;?>>Não</option>
      </select>
     ...
     <div class="form-group col-md-2">
      ...
      <option value="">SELECIONE</option>
      	<option value="S" <?php if($descNoticia->ativo == 'S'): echo "selected"; endif;?>>Sim</option>
      	<option value="N" <?php if($descNoticia->ativo == 'N'): echo "selected"; endif;?>>Não</option>
      </select>
     ...
     <div class="form-group col-md-2">
      ...
      <select name="principal" id="principal" class="form-control">
      	<option value="">SELECIONE</option>
      	<option value="S" <?php if($descNoticia->principal == 'S'): echo "selected"; endif;?>>Sim</option>
      	<option value="N" <?php if($descNoticia->principal == 'N'): echo "selected"; endif;?>>Não</option>
      </select>
