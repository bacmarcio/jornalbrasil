  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
      ...
      <select name="tipo_empreendimento" id="tipo_empreendimento" class="form-control">
      	...
      	<option value="Casa" <?php if($dadosOrcamento->tipo_empreendimento == 'Casa') : echo "selected"; endif;?>>Casa</option>
      	<option value="Condominio" <?php if($dadosOrcamento->tipo_empreendimento == 'Condominio') : echo "selected"; endif;?>>Condominio</option>
      	<option value="Ed. Comercial" <?php if($dadosOrcamento->tipo_empreendimento == 'Ed. Comercial') : echo "selected"; endif;?>>Ed. Comercial</option>
      	<option value="Industria" <?php if($dadosOrcamento->tipo_empreendimento == 'Industria') : echo "selected"; endif;?>>Industria</option>
      </select>
    </div>
  </div>
    ...
    <div class="form-group col-md-4">
     ...
     <div class="form-group col-md-4">
      ...
      <select name="tipo_ligacao" id="tipo_ligacao" class="form-control">
      	<option value="">SELECIONE</option>
      	<option value="Monofásica" <?php if($dadosOrcamento->tipo_ligacao == 'Monofásica') : echo "selected"; endif;?>>Monofásica</option>
      	<option value="Bifásica" <?php if($dadosOrcamento->tipo_ligacao == 'Bifásica') : echo "selected"; endif;?>>Bifásica</option>
      	<option value="Trifásica" <?php if($dadosOrcamento->tipo_ligacao == 'Trifásica') : echo "selected"; endif;?>>Trifásica</option>
      </select>
    </div>
  </div>
  <div class="row">
     <div class="form-group col-md-6">
      ...
      <select name="tipo_local_instalacao" id="tipo_local_instalacao" class="form-control">
      	<option value="">SELECIONE</option>
      	<option value="Telhado de Fibrocimento" <?php if($dadosOrcamento->tipo_local_instalacao == 'Telhado de Fibrocimento') : echo "selected"; endif;?>>Telhado de Fibrocimento</option>
      	<option value="Laje" <?php if($dadosOrcamento->tipo_local_instalacao == 'Laje') : echo "selected"; endif;?>>Laje</option>
      	<option value="Telhado de Telha de Barro" <?php if($dadosOrcamento->tipo_local_instalacao == 'Telhado de Telha de Barro') : echo "selected"; endif;?>>Telhado de Telha de Barro</option>
      	<option value="Outro" <?php if($dadosOrcamento->tipo_local_instalacao == 'Outro') : echo "selected"; endif;?>>Outro</option>
      </select>
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      <select name="id_colaborador" id="id_colaborador" class="form-control">
      	...
      	<option value="<?php echo $colaborador->id;?>" <?php if($dadosOrcamento->id_colaborador == $colaborador->id) : echo "selected"; endif;?>><?php echo $colaborador->nome;?></option>
      	<?php endforeach;?>
      </select>
    </div>
  </div>
