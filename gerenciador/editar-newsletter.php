...
$dadosNewsletter = $newsletter->rsDados(intval($_GET['id']));
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div id="actions" class="row">
    <div class="col-md-12">
      ...
      <a href="newsletter.php" class="btn btn-default">Cancelar</a>
    </div>
  </div>
  <input type="hidden" name="acao" value="editarNewsletter">
