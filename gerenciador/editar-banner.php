  ...
  <main class="container">
    ...
    <div class="form-group col-md-6">
      ...
      <select name="posicao" id="posicao" class="form-control">
      	...
      	<option value="E" <?php if ($descBanner->posicao == 'E') : echo "selected";
                          endif; ?>>Esquerda 150x330</option>
      	<option value="D" <?php if ($descBanner->posicao == 'D') : echo "selected";
                          endif; ?>>Direita 310x310</option>
      	<option value="DE" <?php if ($descBanner->posicao == 'DE') : echo "selected";
                            endif; ?>>Direita Especial 310x310</option>
      	<option value="R1" <?php if ($descBanner->posicao == 'R1') : echo "selected";
                            endif; ?>>Rodapé 970x90</option>
      	<option value="R2" <?php if ($descBanner->posicao == 'R2') : echo "selected";
                            endif; ?>>Rodapé 310x310</option>
      </select>
