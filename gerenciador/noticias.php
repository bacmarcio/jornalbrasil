                ...
                <?php if (count($puxaBlogs) > 0) {
                    foreach ($puxaBlogs as $blog) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn azm-social azm-btn azm-border-bottom azm-facebook" target="_blank" href="https://www.facebook.com/sharer.php?u=http%3A%2F%2Fjornalbrasil.com.br%2Fdesc-noticia.php%3Fid%3D<?php echo $blog->id; ?>"><i class="fa fa-facebook"></i> </a>
                                <a class="btn azm-social azm-btn azm-border-bottom azm-twitter" target="_blank" href="https://twitter.com/intent/tweet?url=http%3A%2F%2Fjornalbrasil.com.br%2Fdesc-noticia.php%3Fid%3D<?php echo $blog->id; ?>"><i class="fa fa-twitter"></i> </a>
                                <a class="btn azm-social azm-btn azm-border-bottom azm-whatsapp" id="by-popup" target="_blank" href="https://api.whatsapp.com/send?text= http://jornalbrasil.com.br/desc-noticia.php?id%3D<?php echo $blog->id; ?>"><i class="fa fa-whatsapp"></i> </a>
                            </td>
