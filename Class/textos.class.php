	...
	class Textos {
		...
		function add($redireciona='') {
			if(isset($_POST['acao']) && $_POST['acao'] == 'addTexto') {
				...
				$data_postagem = filter_input(INPUT_POST, 'data_postagem', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		function editar($redireciona='textos.php') {
			if(isset($_POST['acao']) && $_POST['acao'] == 'editaTexto') {
				...
				//$texto = htmlentities(filter_input(INPUT_POST, 'texto', FILTER_SANITIZE_SPECIAL_CHARS));
				$texto = $_POST['texto'];
				$meta_title = filter_input(INPUT_POST, 'meta_title', FILTER_SANITIZE_SPECIAL_CHARS);
				$meta_keywords = filter_input(INPUT_POST, 'meta_keywords', FILTER_SANITIZE_SPECIAL_CHARS);
				$meta_description = filter_input(INPUT_POST, 'meta_description', FILTER_SANITIZE_SPECIAL_CHARS);
