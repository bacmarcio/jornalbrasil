	...
	class Contatos {
		...
		function add($redireciona='') {
			if(isset($_POST['acao']) && $_POST['acao'] == 'addContato') {
				...
				$veio_de_onde1 = filter_input(INPUT_POST, 'veio_de_onde', FILTER_SANITIZE_SPECIAL_CHARS);
				$status = "EA";
				$id_campanha = filter_input(INPUT_POST, 'id_campanha', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		function editar($redireciona='contatos.php') {
			if(isset($_POST['acao']) && $_POST['acao'] == 'editaContato') {
				...
				$veio_de_onde = filter_input(INPUT_POST, 'veio_de_onde', FILTER_SANITIZE_SPECIAL_CHARS);
				$status = filter_input(INPUT_POST, 'status', FILTER_SANITIZE_SPECIAL_CHARS);
				$observacao = filter_input(INPUT_POST, 'observacao', FILTER_SANITIZE_SPECIAL_CHARS);
				$data_registro = filter_input(INPUT_POST, 'data_registro', FILTER_SANITIZE_SPECIAL_CHARS);
				$hora_registro = filter_input(INPUT_POST, 'hora_registro', FILTER_SANITIZE_SPECIAL_CHARS);
