<?php
if (isset($DepoimentosInstanciada)) {
	...
	class Depoimentos
	{
		...
		function add($mensagemAlert = '', $redireciona = '')
		{
			...
			if (isset($_POST['acao']) && $_POST['acao'] == 'addDepoimentos') {
		...
		{
			if (isset($_POST['acao']) && $_POST['acao'] == 'editarDepoimentos') {
		...
		function excluir()
		{
			if (isset($_GET['acao']) && $_GET['acao'] == 'excluirDepoimentos') {
