...
if($ContratosApartamentosInstanciada == '') {
	...
	class ContratosApartamentos {
		...
		function add($redireciona='') {
			if($_POST['acao'] == 'addContratosApartamentos') {
		...
		function editar($redireciona='contratoApartamentos.php') {
			if($_POST['acao'] == 'editarContratosApartamentos') {
				try { 
		...
		function excluir() {
			if($_GET['acao'] == 'excluirContratosApartamentos') {
